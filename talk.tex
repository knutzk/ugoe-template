...
\def\insertlogos{%
  \includegraphics[height=1.3cm]{logos/BMBF-Gef-Logo}%
  \hspace{1cm}%
  \includegraphics[height=1.3cm]{logos/FSP101-Atlas-Logo}%
  \hspace{1cm}%
  \includegraphics[height=1.3cm]{logos/helmholtz_logo}%
  \hspace{1cm}%
  \includegraphics[height=1.3cm]{logos/logo-uni-goe-notext.pdf}%
}
